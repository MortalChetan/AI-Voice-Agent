...
print("\n" + "🎯" * 50)
print("🚀 COFFEE SHOP AGENT - TUTORIAL BY MORTALCHETAN")
...
class BaristaAgent(Agent):
    def __init__(self):
        super().__init__(
            instructions="""
            🏪 You are a FRIENDLY and PROFESSIONAL barista at "MortalChetan Cafe".
...
async def entrypoint(ctx: JobContext):
    ...
    print("👨‍⚕️ Tutorial by MortalChetan")
...
if __name__ == "__main__":
    ...
    print("👨‍⚕️ Developed by MortalChetan")
    print("⚡" * 25 + "\n")
